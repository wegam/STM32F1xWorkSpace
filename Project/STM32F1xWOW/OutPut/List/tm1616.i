#line 1 "..\\..\\Driver\\Components\\SCR\\TM1616.C"
#line 1 "..\\..\\Driver\\Components\\INC\\TM1616.H"
...
#line 4 "..\\..\\Driver\\Components\\INC\\TM1616.H"
...
#line 2 "..\\..\\Driver\\Components\\SCR\\TM1616.C"
...
#line 3 "..\\..\\Driver\\Components\\SCR\\TM1616.C"


unsigned char TM1616_Daddr[]={0XC0,0XC2,0XC4,0XC6,0XC8,0XCA,0XCC,0XCE};			
unsigned char TM1616_SegCode[]={0x3F,0X06,0X5B,0X4F,0x66,0X6D,0X7D,0x07,0x7f,0x6f,0x00,0xff};
unsigned char TM1616_CovSeg[8]={0};			
...
void TM1616_Initialize(TM1616Def *Pinfo)
{
	GPIO_Configuration_OPP50	(Pinfo->DIO_PORT,		Pinfo->DIO_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->CLK_PORT,		Pinfo->CLK_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->STB_PORT,		Pinfo->STB_Pin);			
}
...
void TM1616_Display(TM1616Def *Pinfo,u16 Data)
{
	TM1616_WriteCommand(Pinfo,0x00);		
	TM1616_WriteCommand(Pinfo,0x40);		

	Pinfo->STB_PORT->BRR = Pinfo->STB_Pin;		
	
	TM1616_Delay(2);
	
	TM1616_WriteByte(Pinfo,0xC0);    
	...
	TM1616_Delay(2);
	Pinfo->STB_PORT->BSRR = Pinfo->STB_Pin;		
	
	TM1616_WriteCommand(Pinfo,0x8D);		
}
...
static void TM1616_WriteByte(TM1616Def *Pinfo,unsigned char byted)
{
	...
	for(i=0;i<8;i++)
	{
		...
		if((byted&0x01)==0x01)						 
		{
			Pinfo->DIO_PORT->BSRR = Pinfo->DIO_Pin;		
		}
		else
		{
			Pinfo->DIO_PORT->BRR = Pinfo->DIO_Pin;		
		}
		TM1616_Delay(2);
