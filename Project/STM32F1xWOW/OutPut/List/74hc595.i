#line 1 "..\\..\\Driver\\Components\\SCR\\74HC595.C"
...
#line 1 "..\\..\\Driver\\Components\\INC\\74HC595.H"
...
#line 6 "..\\..\\Driver\\Components\\INC\\74HC595.H"
...
typedef struct	_HC595_Pin
{
	...
	GPIO_TypeDef* 	HC595_SDA_PORT;				
	unsigned short 	HC595_SDA_Pin;				
	
	
	GPIO_TypeDef* 	HC595_SCK_PORT;				
	unsigned short 	HC595_SCK_Pin;				
	
	
	GPIO_TypeDef* 	HC595_RCK_PORT;				
	unsigned short 	HC595_RCK_Pin;				
	
	
	GPIO_TypeDef* 	HC595_CLR_PORT;				
	unsigned short 	HC595_CLR_Pin;				
	
	
	
	GPIO_TypeDef* 	HC595_OE_PORT;				
	unsigned short 	HC595_OE_Pin;				
...
#line 19 "..\\..\\Driver\\Components\\SCR\\74HC595.C"
...
#line 20 "..\\..\\Driver\\Components\\SCR\\74HC595.C"
...
#line 22 "..\\..\\Driver\\Components\\SCR\\74HC595.C"
...
void HC595_PinConf(HC595_Pindef *Pinfo)
{
	GPIO_Configuration_OPP50	(Pinfo->HC595_SDA_PORT,		Pinfo->HC595_SDA_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->HC595_SCK_PORT,		Pinfo->HC595_SCK_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->HC595_RCK_PORT,		Pinfo->HC595_RCK_Pin);			
