#line 1 "..\\..\\Driver\\WOW\\SCR\\STM32_SYS.C"
...
#line 18 "..\\..\\Driver\\WOW\\SCR\\STM32_SYS.C"
...
#line 19 "..\\..\\Driver\\WOW\\SCR\\STM32_SYS.C"
...
void RCC_Configuration_HSI(void)
{
	...
	RCC_DeInit();	  
	RCC_HSICmd(ENABLE); 
	while(RCC_GetFlagStatus(((u8)0x20))==RESET);
	RCC_HCLKConfig(((u32)0x00000000));			 	
	RCC_PCLK2Config(((u32)0x00000000));				 	
	RCC_PCLK1Config(((u32)0x00000400));				 	
	FLASH_SetLatency(((u32)0x00000002));			 	
	FLASH_PrefetchBufferCmd(((u32)0x00000010));	  
	RCC_PLLConfig(((u32)0x00000000),((u32)0x00380000));	 	
	RCC_PLLCmd(ENABLE);										  
	while(RCC_GetFlagStatus(((u8)0x39))==RESET)	 	
	RCC_SYSCLKConfig(((u32)0x00000002));			 	 
	while(RCC_GetSYSCLKSource()!=0x08);					  	
