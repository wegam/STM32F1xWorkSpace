#line 1 "..\\..\\Driver\\WOW\\SCR\\STM32_ADC.C"
...
#line 1 "..\\..\\Driver\\WOW\\INC\\STM32_ADC.H"
...
#line 20 "..\\..\\Driver\\WOW\\INC\\STM32_ADC.H"
...
#line 21 "..\\..\\Driver\\WOW\\INC\\STM32_ADC.H"
...
#line 22 "..\\..\\Driver\\WOW\\INC\\STM32_ADC.H"
...
#line 23 "..\\..\\Driver\\WOW\\INC\\STM32_ADC.H"
...
#line 24 "..\\..\\Driver\\WOW\\INC\\STM32_ADC.H"
typedef struct _ADCList
{
  unsigned char   Rank;             
  unsigned char   ADC_Channel_x;    
  unsigned char   ADC_SampleTime;   
  struct _ADCList  *Next;           
}ADCList;

unsigned char ADC1_DiscConfigurationDMANR(unsigned char Rank,unsigned char ADC_Channel_x,unsigned char ADC_SampleTime);				
...
void ADC1_InitStructure(u8 ADC_NbrOfChannel);										
void ADC1_DMAConfiguration(u32 *ADC_DATA,u32 DMA_BufferSize);		
...
#line 17 "..\\..\\Driver\\WOW\\SCR\\STM32_ADC.C"
...
#line 19 "..\\..\\Driver\\WOW\\SCR\\STM32_ADC.C"
...
#line 20 "..\\..\\Driver\\WOW\\SCR\\STM32_ADC.C"
...
#line 21 "..\\..\\Driver\\WOW\\SCR\\STM32_ADC.C"
...
#line 22 "..\\..\\Driver\\WOW\\SCR\\STM32_ADC.C"
...
void ADC1_InjectedConfiguration(void)			
{	
}
...
{	
  ...
  {    
	...
	RCC_APB2PeriphClockCmd(((u32)0x00000200),ENABLE);	
	RCC_ADCCLKConfig(((u32)0x00008000));										
	
	
	if(ADC_Channel_x<=((u8)0x07))
	{
		RCC_APB2PeriphClockCmd(((u32)0x00000004),ENABLE);		
	}
	else if(ADC_Channel_x>((u8)0x07)&&ADC_Channel_x<=((u8)0x09))
	{
		RCC_APB2PeriphClockCmd(((u32)0x00000008),ENABLE);		
	}
	else if(ADC_Channel_x>((u8)0x09)&&ADC_Channel_x<=((u8)0x0F))
	{
	...
	{
		case	((u8)0x00):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0001);	break;
		case	((u8)0x01):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0002);	break;
		case	((u8)0x02):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0004);	break;
		case	((u8)0x03):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0008);	break;
		case	((u8)0x04):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0010);	break;
		case	((u8)0x05):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0020);	break;
		case	((u8)0x06):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0040);	break;
		case	((u8)0x07):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800));	GPIO_Pin_x=((u16)0x0080);	break;
		case	((u8)0x08):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00));	GPIO_Pin_x=((u16)0x0001);	break;
		case	((u8)0x09):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00));	GPIO_Pin_x=((u16)0x0002);	break;
		case	((u8)0x0A):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));	GPIO_Pin_x=((u16)0x0001);	break;
		case	((u8)0x0B):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));	GPIO_Pin_x=((u16)0x0002);	break;
		case	((u8)0x0C):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));	GPIO_Pin_x=((u16)0x0004);	break;
		case	((u8)0x0D):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));	GPIO_Pin_x=((u16)0x0008);	break;
		case	((u8)0x0E):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));	GPIO_Pin_x=((u16)0x0010);	break;
		case	((u8)0x0F):	GPIOx=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));	GPIO_Pin_x=((u16)0x0020);	break;
  ...
  ADC1_Cmd(DISABLE);
  ADC_DeInit(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)));
	ADC_InitStructure.ADC_Mode 								= ((u32)0x00000000); 			
	ADC_InitStructure.ADC_ScanConvMode 				=	ENABLE; 										
	ADC_InitStructure.ADC_ContinuousConvMode 	= ENABLE; 										
	ADC_InitStructure.ADC_ExternalTrigConv 		= ((u32)0x000E0000); 	
	ADC_InitStructure.ADC_DataAlign 					= ((u32)0x00000000); 				
	ADC_InitStructure.ADC_NbrOfChannel 				= ChannelCount; 			        
	ADC_Init(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), &ADC_InitStructure); 																		
  ...
  {
    ADC_RegularChannelConfig(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ADCDiscTemp->ADC_Channel_x, ADCDiscTemp->Rank,ADCDiscTemp->ADC_SampleTime);
    if(0 ==  ADCDiscTemp->Next)
    {
      break;
    }
	...
	ADC1_DMAConfiguration((u32*)ADCBuffer,ChannelCount);  
...
void ADC_TempSensorConfiguration(u32 *ADC_DATA)
{
	RCC_APB2PeriphClockCmd(((u32)0x00000200),ENABLE);			
	RCC_ADCCLKConfig(((u32)0x00008000));   										
	ADC1_InitStructure(1);																	
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ((u8)0x10), 1,((u8)0x07));	
	ADC1_DMAConfiguration(ADC_DATA,1); 											
	ADC_DMACmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ENABLE);   														
	ADC_TempSensorVrefintCmd(ENABLE);												
	ADC1_Cmd(ENABLE);																				
	
	ADC_ResetCalibration(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)));   													
	while(ADC_GetResetCalibrationStatus(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)))); 	 					
	ADC_StartCalibration(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))); 														
	while(ADC_GetCalibrationStatus(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))));    							
...
void ADC1_DMAConfiguration(u32 *ADCDataBuffer,u32 DMA_BufferSize) 		
{  
	DMA_InitTypeDef DMA_InitStructure; 																					
	RCC_AHBPeriphClockCmd(((u32)0x00000001), ENABLE); 		
  
	DMA_DeInit(((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0008))); 																									  
	DMA_InitStructure.DMA_PeripheralBaseAddr  = (u32)&((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))->DR; 									
	DMA_InitStructure.DMA_MemoryBaseAddr      = (u32)ADCDataBuffer; 						  
	...
	DMA_Init(((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0008)), &DMA_InitStructure); 																  
	DMA_Cmd(((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0008)),ENABLE);																							  
}
...
void ADC1_Cmd(FunctionalState NewState)		
{
  ...
  {		
    ADC_DMACmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ENABLE); 									
		DMA_Cmd(((DMA_Channel_TypeDef *) ((((u32)0x40000000) + 0x20000) + 0x0008)),ENABLE);
		ADC_Cmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ENABLE); 											
		ADC_SoftwareStartConvCmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)),ENABLE);
		ADC_ResetCalibration(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400))); 								
  ...
  {
    ADC_SoftwareStartConvCmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)),DISABLE);
    ADC_DMACmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), DISABLE); 	
		ADC_Cmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), DISABLE); 		
  }
}
