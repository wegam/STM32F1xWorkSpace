#line 1 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
...
#line 10 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
...
#line 11 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
...
#line 13 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"

#line 15 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
#line 16 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
#line 17 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
#line 18 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"

static LCDDef	*ILI9326	=	0;		
...
unsigned short ILI9326_Initialize(void*	pInfo)
{
	...
	DeviceCode	=	ILI9326_ReadRegister(( (u16) 0x0000));
	...
	ILI9326->Data.MaxH	=	240;					
	ILI9326->Data.MaxV	=	400;					
	...
	(ILI9326->Port . sBL_PORT->BSRR = ILI9326->Port . sBL_Pin);
	return DeviceCode;		
}
...
void ILI9326_Reset(void)
{
	(ILI9326->Port . sREST_PORT->BSRR = ILI9326->Port . sREST_Pin);
	LCD_DelaymS(5);				
	(ILI9326->Port . sREST_PORT->BRR = ILI9326->Port . sREST_Pin);;
	LCD_DelaymS(5);				
	(ILI9326->Port . sREST_PORT->BSRR = ILI9326->Port . sREST_Pin);
	LCD_DelaymS(10);				
}
...
unsigned short ILI9326_ReadData(void)
{
	...
	(ILI9326->Port . sRD_PORT->BRR = ILI9326->Port . sRD_Pin);	
	Data	=	(ILI9326->Port . sDATABUS_PORT)->IDR;
	(ILI9326->Port . sRD_PORT->BSRR = ILI9326->Port . sRD_Pin);	
#line 156 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
	return Data;
}
...
{
	unsigned short Data	=	0;
	(ILI9326->Port . sCS_PORT->BRR = ILI9326->Port . sCS_Pin);	
	
	ILI9326_WriteAddr(Index);
	
	GPIO_Configuration_IPU	((ILI9326->Port . sDATABUS_PORT),(ILI9326->Port . sDATABUS_Pin));			
	Data	=	ILI9326_ReadData();
	(ILI9326->Port . sCS_PORT->BSRR = ILI9326->Port . sCS_Pin);	
	GPIO_Configuration_OPP50	((ILI9326->Port . sDATABUS_PORT),(ILI9326->Port . sDATABUS_Pin));		
	return Data;
}
...
void ILI9326_WriteData(unsigned	short	Data)
{
	...
	(ILI9326->Port . sWR_PORT->BRR = ILI9326->Port . sWR_Pin);	
	(ILI9326->Port . sDATABUS_PORT)->ODR = Data;
	(ILI9326->Port . sWR_PORT->BSRR = ILI9326->Port . sWR_Pin);	
#line 204 "..\\..\\Driver\\Components\\SCR\\ILI9326.c"
}
...
void ILI9326_WriteAddr(unsigned	short	Addr)
{
	(ILI9326->Port . sDC_PORT->BRR = ILI9326->Port . sDC_Pin);	
	ILI9326_WriteData(Addr);
	(ILI9326->Port . sDC_PORT->BSRR = ILI9326->Port . sDC_Pin);	
}
...
{
	ILI9326_WriteCommand( ( (u16) 0x0007), 0x0000 );
}
...
void ILI9326_PowerOn( void )
{
  ...
  void(*DelaymS)(unsigned long xms) = LCD_DelaymS;
	...
	ILI9326_WriteCMD( ( (u16) 0x0702), 	0x3008 ); 
	ILI9326_WriteCMD( ( (u16) 0x0705), 	0x0036 ); 
	ILI9326_WriteCMD( ( (u16) 0x070B), 	0x1213 ); 

	ILI9326_WriteCMD( ( (u16) 0x0001), 	0x0100 ); 
	ILI9326_WriteCMD( ( (u16) 0x0002), 	0x0100 ); 
	ILI9326_WriteCMD( ( (u16) 0x0003), 		0x1030 ); 
	ILI9326_WriteCMD( ( (u16) 0x0008), 	0x0202 ); 
	ILI9326_WriteCMD( ( (u16) 0x0009), 	0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x000C),	0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x000F),	0x0000 ); 

	 
	ILI9326_WriteCMD( ( (u16) 0x0100), 	0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0102), 	0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0103), 	0x0000 ); 
	
	DelaymS( 100 );
	
	ILI9326_WriteCMD( ( (u16) 0x0100), 	0x1190 );  
	ILI9326_WriteCMD( ( (u16) 0x0101), 	0x0227 );  
	
	DelaymS( 100 );
	
	ILI9326_WriteCMD( ( (u16) 0x0102), 	0x01BD );  
	
	DelaymS( 100 );
	
	ILI9326_WriteCMD( ( (u16) 0x0103),		0x2D00 ); 
	ILI9326_WriteCMD( ( (u16) 0x0281), 	0x000E ); 
	
	
	ILI9326_WriteCMD( ( (u16) 0x0200), 		0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0201), 		0x0000 ); 

	 
	ILI9326_WriteCMD( ( (u16) 0x0300),		0x0000 );
	ILI9326_WriteCMD( ( (u16) 0x0301), 	0x0707 );
	ILI9326_WriteCMD( ( (u16) 0x0302), 	0x0606 );
	ILI9326_WriteCMD( ( (u16) 0x0303), 	0x0000 );
	ILI9326_WriteCMD( ( (u16) 0x0304), 	0x0D00 );
	ILI9326_WriteCMD( ( (u16) 0x0305), 	0x0706 );
	ILI9326_WriteCMD( ( (u16) 0x0306), 	0x0005 );
	ILI9326_WriteCMD( ( (u16) 0x0307), 	0x0007 );

	ILI9326_WriteCMD( ( (u16) 0x0308), 	0x0000 );
	ILI9326_WriteCMD( ( (u16) 0x0309), 	0x000A );

	 
	ILI9326_WriteCMD( ( (u16) 0x0210), 	0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0211), 	0x00EF ); 
	ILI9326_WriteCMD( ( (u16) 0x0212), 	0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0400), 	0x3100 ); 
	ILI9326_WriteCMD( ( (u16) 0x0401), 	0x0001 ); 
	ILI9326_WriteCMD( ( (u16) 0x0404), 0x0000 ); 

 
	ILI9326_WriteCMD( ( (u16) 0x0500), 0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0501), 0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0502), 0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0503), 0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0504), 0x0000 ); 
	ILI9326_WriteCMD( ( (u16) 0x0505), 0x0000 ); 

 
	ILI9326_WriteCMD( ( (u16) 0x0010), 0x0010 ); 
	ILI9326_WriteCMD( ( (u16) 0x0011), 0x0600 ); 
	ILI9326_WriteCMD( ( (u16) 0x0013), 0x0002 ); 

	ILI9326_WriteCMD( ( (u16) 0x0007), 0x0173 ); 
}
...
void ILI9326_PowerOff( void )
{
	...
	ILI9326_WriteCommand( ( (u16) 0x0009), 0 );	
}
...
{
  void(*ILI9326_WriteCMD)(unsigned short Index,unsigned short Command)	=	ILI9326->Display.WriteCommand;
	...
	ILI9326_WriteCMD(( (u16) 0x0210),ILI9326->Data.HSX);		
	ILI9326_WriteCMD(( (u16) 0x0211),ILI9326->Data.HEX);		
	ILI9326_WriteCMD(( (u16) 0x0212),ILI9326->Data.VSY);		
	ILI9326_WriteCMD(( (u16) 0x0213),ILI9326->Data.VEY);		
	
	ILI9326_WriteCMD( ( (u16) 0x0200), ILI9326->Data.HSX );
	ILI9326_WriteCMD( ( (u16) 0x0201), ILI9326->Data.VSY );
	
	ILI9326_WriteCMD( ( (u16) 0x0003), Model);
	
	ILI9326_WriteIndex( ( (u16) 0x0202) );
}
...
{
	ILI9326_SetWindowAddress(HSX,HSY,HSX,HSY);	
												...
												)
{
	...
	while(a<=b)
	{
		if(Filled)	
		{
			...
			ILI9326_DrawLine(x,y,x+b,y-a,color);             
			ILI9326_DrawLine(x,y,x-a,y+b,color);             
			ILI9326_DrawLine(x,y,x-b,y-a,color);             
			ILI9326_DrawLine(x,y,x-a,y-b,color);             
			ILI9326_DrawLine(x,y,x+b,y+a,color);             
			ILI9326_DrawLine(x,y,x+a,y-b,color);             
