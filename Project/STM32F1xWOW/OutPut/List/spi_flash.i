#line 1 "..\\..\\Driver\\Protocol\\SPI_FLASH.C"
...
#line 19 "..\\..\\Driver\\Protocol\\SPI_FLASH.C"
...
#line 22 "..\\..\\Driver\\Protocol\\SPI_FLASH.C"
...
void SPI_FLASH_PageWrite(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
	if(NumByteToWrite>FlashSYS->Memory.PageSize)		
	{
...
void SPI_FLASH_BufferWrite(u8* pBuffer, u32 StartAddr, u16 NumByteToWrite)
{
  u8 NumOfPage = 0, NumOfSingle = 0, Addr = 0, count = 0, temp = 0;
	unsigned long	SPI_FLASH_PageSize	=	0;	
	unsigned long	WriteAddr	=	StartAddr;		
...
void SPI_FLASH_BufferRead(u8* pBuffer, u32 ReadAddr, u16 NumByteToRead)
{
  ...
  while (NumByteToRead--)  
  {
    ...
    *pBuffer = SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);
...
u32 SPI_FLASH_ReadRDSFDP(void)
{
  ...
  SPI_ReadWriteByteSPI(&FlashSYS->SPI,FlashSYS->Cmd.RDSFDP);
	...
	SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);
	
   
  Temp0 = SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);

   
  Temp1 = SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);
...
u32 SPI_FLASH_ReadID(void)
{
  ...
  Temp2 = SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);
...
u32 SPI_FLASH_ReadStatusRegister(void)
{
  ...
  Temp = SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);
...
void SPI_FLASH_WaitForWriteEnd(void)
{
  ...
  do
  {
    ...
    FLASH_Status = SPI_ReadWriteByteSPI(&FlashSYS->SPI,0xA5);
  }
  while (((FLASH_Status & 0x01) == SET)&&(Time--));  
