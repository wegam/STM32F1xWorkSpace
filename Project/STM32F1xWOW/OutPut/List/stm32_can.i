#line 1 "..\\..\\Driver\\WOW\\SCR\\STM32_CAN.C"
...
#line 1 "..\\..\\Driver\\WOW\\INC\\STM32_CAN.H"
...
#line 22 "..\\..\\Driver\\WOW\\INC\\STM32_CAN.H"




#line 27 "..\\..\\Driver\\WOW\\INC\\STM32_CAN.H"
...
void CAN_Configuration_NR(u32 CAN_BaudRate);				
void CAN_Configuration_IT(u32 CAN_BaudRate);				


void CAN_FilterInitConfiguration_StdData(u8 CAN_GROUP,u16 CAN_ID,u16 MaskId);	
void CAN_FilterInitConfiguration_ExtData(u8 CAN_GROUP,u32 CAN_ID,u32 MaskId);	


ErrorStatus CAN_PinSet(CANRemap_TypeDef CANRemap_Status);		


void CAN_StdTX_DATA(u16 CAN_ID,u8 length,u8 *Data);			
void CAN_ExtTX_DATA(u32 CAN_ID,u8 length,u8 *Data);			
...
#line 19 "..\\..\\Driver\\WOW\\SCR\\STM32_CAN.C"
...
#line 21 "..\\..\\Driver\\WOW\\SCR\\STM32_CAN.C"
...
#line 22 "..\\..\\Driver\\WOW\\SCR\\STM32_CAN.C"
#line 23 "..\\..\\Driver\\WOW\\SCR\\STM32_CAN.C"
...
#line 24 "..\\..\\Driver\\WOW\\SCR\\STM32_CAN.C"
...
void CAN_Configuration_NR(u32 CAN_BaudRate)					
{
  ...
  CAN_InitStructure.CAN_Mode=((u8)0x00);			
  ...
  CAN_InitStructure.CAN_BS1=((u8)0x04);	
	
  CAN_InitStructure.CAN_BS2=((u8)0x02);	
...
void CAN_Configuration_IT(u32 CAN_BaudRate)					
{
  ...
  CAN_Init(&CAN_InitStructure);	
	...
	NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x13);
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 3;
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
	NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
	NVIC_Init(&NVIC_InitStructure);
	
	CAN_ITConfig(((u32)0x00000002) | ((u32)0x00000004) | ((u32)0x00000008), ENABLE);  	
	CAN_ITConfig(((u32)0x00000010) | ((u32)0x00000020) | ((u32)0x00000040), DISABLE);  
	CAN_ITConfig(((u32)0x00000001), DISABLE); 
...
)		
{
  ...
  CAN_FilterInitStructure.CAN_FilterNumber=CAN_GROUP;						
  ...
  CAN_FilterInitStructure.CAN_FilterMaskIdHigh=(((u32)MaskId<<21)&0xffff0000)>>16;					
...
)		
{
  ...
  CAN_FilterInitStructure.CAN_FilterIdLow=(((u32)CAN_ID<<3)|((u32)0x00000004)|((u32)0x00000000))&0xFFFF;;								
...
ErrorStatus CAN_PinSet(CANRemap_TypeDef CANRemap_Status)						
{
	...
	else if(CANRemap_Status==CANRemap1)
	{
		...
		GPIO_PinRemapConfig(((u32)0x001D4000), ENABLE);
	...
	else if(CANRemap_Status==CANRemap2)
	{
		...
		GPIO_PinRemapConfig(((u32)0x001D6000), ENABLE);
...
u8 CAN_RX_DATA(CanRxMsg *RxMessage)
{
		...
		CAN_ClearITPendingBit(((u32)0x00000004));
		CAN_ClearITPendingBit(((u32)0x00000004));
		
		if(0	!=	(((CAN_TypeDef *) (((u32)0x40000000) + 0x6400))->RF0R&0x03))	
		{
		...
		else if(0	!=	(((CAN_TypeDef *) (((u32)0x40000000) + 0x6400))->RF1R&0x03))	
		{
			CAN_Receive(((u8)0x01), RxMessage);
			return 1;
		}
