#line 1 "..\\..\\Driver\\Components\\SCR\\DRV8801.C"

#line 1 "..\\..\\Driver\\Components\\INC\\DRV8801.H"
...
#line 4 "..\\..\\Driver\\Components\\INC\\DRV8801.H"
...
typedef struct	_DRV8801_Pin
{
	...
	GPIO_TypeDef* 	DRV8801_VPORTI_PORT;			
	unsigned short 	DRV8801_VPORTI_Pin;				
	
	
	GPIO_TypeDef* 	DRV8801_EN_PORT;					
	unsigned short 	DRV8801_EN_Pin;						
	
	
	GPIO_TypeDef* 	DRV8801_SLEEP_PORT;				
	unsigned short 	DRV8801_SLEEP_Pin;				
	
	
	GPIO_TypeDef* 	DRV8801_PHASE_PORT;				
	unsigned short 	DRV8801_PHASE_Pin;				
	
	
	GPIO_TypeDef* 	DRV8801_MODE1_PORT;				
	unsigned short 	DRV8801_MODE1_Pin;				
	
	
	GPIO_TypeDef* 	DRV8801_MODE2_PORT;				
	unsigned short 	DRV8801_MODE2_Pin;				
	
	
	GPIO_TypeDef* 	DRV8801_FAULT_PORT;				
	unsigned short 	DRV8801_FAULT_Pin;				
...
#line 3 "..\\..\\Driver\\Components\\SCR\\DRV8801.C"
...
#line 4 "..\\..\\Driver\\Components\\SCR\\DRV8801.C"
...
void DRV8801_PinConf(DRV8801_Pindef *Pinfo)
{
	GPIO_Configuration_INA		(Pinfo->DRV8801_VPORTI_PORT,	Pinfo->DRV8801_VPORTI_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->DRV8801_EN_PORT,			Pinfo->DRV8801_EN_Pin);					
	GPIO_Configuration_OPP50	(Pinfo->DRV8801_SLEEP_PORT,		Pinfo->DRV8801_SLEEP_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->DRV8801_PHASE_PORT,		Pinfo->DRV8801_PHASE_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->DRV8801_MODE1_PORT,		Pinfo->DRV8801_MODE1_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->DRV8801_MODE2_PORT,		Pinfo->DRV8801_MODE2_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->DRV8801_FAULT_PORT,		Pinfo->DRV8801_FAULT_Pin);			
...
void DRV8801_CW(DRV8801_Pindef *Pinfo)
{
	...
	GPIO_SetBits(Pinfo->DRV8801_PHASE_PORT, Pinfo->DRV8801_PHASE_Pin);		
	GPIO_SetBits(Pinfo->DRV8801_EN_PORT, Pinfo->DRV8801_EN_Pin);					
	GPIO_SetBits(Pinfo->DRV8801_SLEEP_PORT, Pinfo->DRV8801_SLEEP_Pin);		
...
void DRV8801_CCW(DRV8801_Pindef *Pinfo)
{
	...
	GPIO_ResetBits(Pinfo->DRV8801_PHASE_PORT, Pinfo->DRV8801_PHASE_Pin);	
	GPIO_SetBits(Pinfo->DRV8801_EN_PORT, Pinfo->DRV8801_EN_Pin);					
	GPIO_SetBits(Pinfo->DRV8801_SLEEP_PORT, Pinfo->DRV8801_SLEEP_Pin);		
...
void DRV8801_Brake_SN(DRV8801_Pindef *Pinfo)
{
	...
	GPIO_ResetBits(Pinfo->DRV8801_PHASE_PORT, Pinfo->DRV8801_PHASE_Pin);	
	GPIO_ResetBits(Pinfo->DRV8801_EN_PORT, Pinfo->DRV8801_EN_Pin);					
	GPIO_SetBits(Pinfo->DRV8801_MODE1_PORT, Pinfo->DRV8801_MODE1_Pin);		
	GPIO_ResetBits(Pinfo->DRV8801_MODE2_PORT, Pinfo->DRV8801_MODE2_Pin);		
...
void DRV8801_Brake_SP(DRV8801_Pindef *Pinfo)
{
	...
	GPIO_ResetBits(Pinfo->DRV8801_EN_PORT, Pinfo->DRV8801_EN_Pin);					
	GPIO_SetBits(Pinfo->DRV8801_MODE1_PORT, Pinfo->DRV8801_MODE1_Pin);		
	GPIO_SetBits(Pinfo->DRV8801_MODE2_PORT, Pinfo->DRV8801_MODE2_Pin);		
...
void DRV8801_Brake_FCW(DRV8801_Pindef *Pinfo)
{
	...
	GPIO_ResetBits(Pinfo->DRV8801_MODE1_PORT, Pinfo->DRV8801_MODE1_Pin);		
	GPIO_SetBits(Pinfo->DRV8801_MODE2_PORT, Pinfo->DRV8801_MODE2_Pin);		
