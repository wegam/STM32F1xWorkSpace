#line 1 "..\\..\\Driver\\Protocol\\I2C.C"
#line 1 "..\\..\\Driver\\Protocol\\I2C.H"
...
#line 7 "..\\..\\Driver\\Protocol\\I2C.H"




typedef	enum	_I2CACK				
{
	I2C_NACK	=0,
	I2C_ACK		=1
}I2CACKDef;
...
typedef	struct	_I2CDATA				
{
	...
	unsigned short WPageStart;	
	unsigned short WPageAddr;		
	unsigned short WDataTotal;	
	unsigned short WDataSize;		
	unsigned char  DeviceAddr;	
	unsigned char* WDataAddr;		
}sI2CDATADef;
typedef	struct					
{
...
void I2C_Configuration(sI2CDef *sI2C);		
...
void I2C_WriteOneByte(sI2CDef *sI2C,unsigned short address,unsigned char ucByte);	
...
#line 6 "..\\..\\Driver\\Protocol\\I2C.C"
#line 7 "..\\..\\Driver\\Protocol\\I2C.C"
...
void I2C_Configuration(sI2CDef *sI2C)		
{
	...
	GPIO_Configuration_OPP50	(sI2C->HW.SDA_Port,sI2C->HW.SDA_Pin);			
	
	GPIO_Configuration_OPP50	(sI2C->HW.SCL_Port,sI2C->HW.SCL_Pin);			
	
	GPIO_SetBits(sI2C->HW.SCL_Port,sI2C->HW.SCL_Pin);
	GPIO_SetBits(sI2C->HW.SDA_Port,sI2C->HW.SDA_Pin);	
	
	sI2C->DATA.EEtype=AT24C02;		
...
void I2C_SDASetOut(sI2CDef *sI2C)
{
	I2C_SCLLow(sI2C);
	I2C_SDALow(sI2C);
	GPIO_RegConfiguration_OPP50	(sI2C->HW.SDA_Port,sI2C->HW.SDA_Pin);	
...
void I2C_SDASetIn(sI2CDef *sI2C)
{
	I2C_SCLLow(sI2C);
	I2C_SDALow(sI2C);
	GPIO_Configuration_INF	(sI2C->HW.SDA_Port,sI2C->HW.SDA_Pin);			
}
...
unsigned char I2C_WaitAck(sI2CDef *sI2C)
{
	...
	while((I2C_ReadBit(sI2C))&&(i++<=40000))		
	if(i>=40000-1)		
	{
		ack	= I2C_NACK;
	}
...
void I2C_WriteNbyte(sI2CDef *sI2C,unsigned short address,const unsigned char* pBuffer,unsigned short length)
{
	...
	I2C_SendByte(sI2C,sI2C->DATA.DeviceAddr);	
	if(!I2C_WaitAck(sI2C))
	{		
		goto stopI2C;
	}
...
void I2C_WriteBuffer(sI2CDef *sI2C,unsigned short address,const unsigned char* pBuffer,unsigned short length)
{
	...
	if(0!=StartAddress%sI2C->DATA.PageSize)	
	{
		WriteLen=(address/sI2C->DATA.PageSize+1)*sI2C->DATA.PageSize-StartAddress;	
	...
	WWritelen=WWritelen-WriteLen;		
	if(WWritelen>0)
	{
		StartAddress=StartAddress+WriteLen;		
		DataAddr=&DataAddr[WriteLen];	
		I2C_Delayms(5);		
		do		
		{
			I2C_Start(sI2C);
