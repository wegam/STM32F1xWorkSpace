#line 1 "..\\..\\Driver\\Protocol\\swd_pin.c"
...
#line 2 "..\\..\\Driver\\Protocol\\swd_pin.c"
...
void SW_PinInit(void)
{
    ...
    ((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->CRL &=0xFFFFF0FF;((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->CRL |=0x00000300;;	
...
{
    unsigned long bit;    
    bit = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)),((u16)0x0400));
		((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)) ->BSRR = ((u16)0x0200);				
		((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)) ->BRR = ((u16)0x0200);		
    return bit;
}
