#line 1 "..\\..\\Driver\\Components\\SCR\\74HC165.C"
...
#line 1 "..\\..\\Driver\\Components\\INC\\74HC165.H"
...
#line 6 "..\\..\\Driver\\Components\\INC\\74HC165.H"
...
typedef struct _HC165_CONF
{
	...
	unsigned short 	PL_Pin;					
	
	
	GPIO_TypeDef* 	CP_PORT;				
	unsigned short 	CP_Pin;					
	...
	GPIO_TypeDef* 	Q7_PORT;				
	unsigned short 	Q7_Pin;					
...
#line 11 "..\\..\\Driver\\Components\\SCR\\74HC165.C"
...
#line 13 "..\\..\\Driver\\Components\\SCR\\74HC165.C"
...
void HC165Conf(HC165_CONF *HC165x)
{
	...
	GPIO_Configuration_OPP50	(HC165x->PL_PORT,		HC165x->PL_Pin);			
	
	GPIO_Configuration_OPP50	(HC165x->CP_PORT,		HC165x->CP_Pin);			
	
	GPIO_Configuration_OPP50	(HC165x->CE_PORT,		HC165x->CE_Pin);			
	
	GPIO_Configuration_IPU	(HC165x->Q7_PORT,		HC165x->Q7_Pin);				
}
...
unsigned long HC165Read(HC165_CONF *HC165x)
{
	...
	unsigned long *P=(unsigned long*)&HC165x->HC165_Data.Data32;		
	
	HC165x->CE_PORT->BRR 	= HC165x->CE_Pin;		
	HC165x->PL_PORT->BRR	=	HC165x->PL_Pin;		
	__nop();			
	HC165x->PL_PORT->BSRR	=	HC165x->PL_Pin;		
	for(i=0;i<HC165x->HC165_Data.NumOfHC165*8;i++)
	{
		reValue<<=1;			
		HC165x->CP_PORT->BRR	=	HC165x->CP_Pin;	
		__nop();					
		if(HC165x->Q7_PORT->IDR&HC165x->Q7_Pin)
		{
			reValue|=0x01;
		}
		HC165x->CP_PORT->BSRR	=	HC165x->CP_Pin;	
	}	
	HC165x->CE_PORT->BSRR	=	HC165x->CE_Pin;		
	*P=reValue;
	return	reValue;	
}
...
void HC165_TEST(HC165_CONF *HC165x)
{
	...
	HC165x->PL_PORT=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));
	HC165x->PL_Pin=((u16)0x0001);
	
	
	HC165x->CP_PORT=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));
	HC165x->CP_Pin=((u16)0x0002);
	
	
	HC165x->CE_PORT=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));
	HC165x->CE_Pin=((u16)0x0004);
	
	
	HC165x->Q7_PORT=((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000));
	HC165x->Q7_Pin=((u16)0x0008);
	
	HC165x->HC165_Data.NumOfHC165=2;		
