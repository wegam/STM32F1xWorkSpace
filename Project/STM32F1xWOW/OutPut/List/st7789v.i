#line 1 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
...
#line 7 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
...
#line 8 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
...
#line 9 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
...
#line 10 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"


#line 13 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"

#line 15 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
#line 16 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
#line 17 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
#line 18 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
...
unsigned short ST7789VBColor  = 0x0000;   
unsigned short ST7789VPColor  = 0xFFFF;   

char	ST7789VStringBuffer[256]={0};			
ST7789VRotateDef	ST7789VRotate	=	ST7789V_Rotate_90D;		
...
unsigned int ST7789V_Printf(u16 x,u16 y,u8 font,u16 color,const char *format,...)				
{ 
#line 104 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
#line 105 "..\\..\\Driver\\Components\\SCR\\ST7789V.C"
...
{
	unsigned short	MaxV=320,MaxH=240;	
	unsigned char i=0;
	...
	for(i=0;i<num;i++)
	{
      ...
      if(y>MaxV-font)
      {
        y=x=0;
			...
			GetBufferLength	=	GT32L32_GetCode(font,word,CodeBuffer);		
      ...
      if(y>MaxV-font)
      {
        y=x=0;
			...
			GetBufferLength	=	GT32L32_GetCode(font,(u16)dst,CodeBuffer);		
...
void ST7789V_Enable(void)
{
	(pST7789V->sDC_PORT->BSRR = pST7789V->sDC_Pin);  
  (pST7789V->sRD_PORT->BSRR = pST7789V->sRD_Pin);  
  (pST7789V->sWR_PORT->BSRR = pST7789V->sWR_Pin);  
  
  (pST7789V->sCS_PORT->BRR = pST7789V->sCS_Pin);   
}
...
void ST7789V_Disable(void)
{
  (pST7789V->sCS_PORT->BSRR = pST7789V->sCS_Pin);  
...
{
	(pST7789V->sDC_PORT->BRR = pST7789V->sDC_Pin);   
  
  (pST7789V->sWR_PORT->BRR = pST7789V->sWR_Pin);   
  (pST7789V->sDATABUS_PORT)->ODR = Command;
  (pST7789V->sWR_PORT->BSRR = pST7789V->sWR_Pin);  
...
{
  (pST7789V->sWR_PORT->BRR = pST7789V->sWR_Pin);   
  (pST7789V->sDATABUS_PORT)->ODR = Data;
  (pST7789V->sWR_PORT->BSRR = pST7789V->sWR_Pin);  
}
...
unsigned short ST7789V_ReadData(void)
{
  ...
  (pST7789V->sRD_PORT->BRR = pST7789V->sRD_Pin);   
  Data  = (pST7789V->sDATABUS_PORT)->IDR;
  (pST7789V->sRD_PORT->BSRR = pST7789V->sRD_Pin);  
	return Data;
}
...
void ST7789V_EnterSleep(void)
{
  ST7789V_WriteCommand(0x28); 
  LCD_DelaymS(10);
  ST7789V_WriteCommand(0x10); 
  PWM_OUT((TIM_TypeDef*) (((u32)0x40000000) + 0x0000),PWM_OUTChannel4,5,0);		
}
...
void ST7789V_SetWindowAddress(unsigned short xs,unsigned short ys,unsigned short xe,unsigned short ye)
{
  ...
  ST7789V_WriteCommand(0x36); 
  ST7789V_WriteData(ST7789VRotate);    
...
{
  ST7789V_Enable();	
	ST7789V_SetWindowAddress(HSX,HSY,HSX,HSY);	
...
)
{
	...
	{  
    ST7789V_SetWindowAddress(uRow,uCol,uRow,uCol);	
    ST7789V_WriteData(Color);
												...
												)
{
	...
	while(a<=b)
	{
		if(Filled)	
		{
			...
			ST7789V_DrawLine(x,y,x+b,y-a,color);             
			ST7789V_DrawLine(x,y,x-a,y+b,color);             
			ST7789V_DrawLine(x,y,x-b,y-a,color);             
			ST7789V_DrawLine(x,y,x-a,y-b,color);             
			ST7789V_DrawLine(x,y,x+b,y+a,color);             
			ST7789V_DrawLine(x,y,x+a,y-b,color);             
