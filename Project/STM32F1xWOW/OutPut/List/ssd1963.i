#line 1 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
...
#line 7 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
...
#line 8 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
...
#line 9 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"

#line 11 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
#line 12 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
#line 13 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
#line 14 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
...
void SSD1963_Initialize(void*	pInfo)
{
	...
	pSSD1963->Data.MaxH	=	800;					
	pSSD1963->Data.MaxV	=	480;					
  ...
  if(0 ==  pSSD1963->Display.WriteIndex)
    pSSD1963->Display.WriteIndex  = SSD1963_WriteIndex;
  if(0 ==  pSSD1963->Display.WriteData)
    pSSD1963->Display.WriteData  = SSD1963_WriteData;
  if(0 ==  pSSD1963->Display.WriteCommand)
...
{
	(pSSD1963->Port . sREST_PORT->BSRR = pSSD1963->Port . sREST_Pin);
	LCD_DelaymS(5);				
	(pSSD1963->Port . sREST_PORT->BRR = pSSD1963->Port . sREST_Pin);;
	LCD_DelaymS(5);				
	(pSSD1963->Port . sREST_PORT->BSRR = pSSD1963->Port . sREST_Pin);
	LCD_DelaymS(10);				
}
...
unsigned short SSD1963_ReadData(void)
{
	...
	(pSSD1963->Port . sRD_PORT->BRR = pSSD1963->Port . sRD_Pin);	
	Data	=	(pSSD1963->Port . sDATABUS_PORT)->IDR;
	(pSSD1963->Port . sRD_PORT->BSRR = pSSD1963->Port . sRD_Pin);	
#line 162 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
	return Data;
}
...
{
	unsigned short Data	=	0;
	(pSSD1963->Port . sCS_PORT->BRR = pSSD1963->Port . sCS_Pin);	
	
	SSD1963_WriteAddr(Addr);
	
	GPIO_Configuration_IPU	((pSSD1963->Port . sDATABUS_PORT),(pSSD1963->Port . sDATABUS_Pin));			
	Data	=	SSD1963_ReadData();
	(pSSD1963->Port . sCS_PORT->BSRR = pSSD1963->Port . sCS_Pin);	
	GPIO_Configuration_OPP50	((pSSD1963->Port . sDATABUS_PORT),(pSSD1963->Port . sDATABUS_Pin));		
	return Data;
}
...
void SSD1963_WriteData(unsigned	short	Data)
{
	...
	(pSSD1963->Port . sWR_PORT->BRR = pSSD1963->Port . sWR_Pin);	
	(pSSD1963->Port . sDATABUS_PORT)->ODR = Data;
	(pSSD1963->Port . sWR_PORT->BSRR = pSSD1963->Port . sWR_Pin);	
#line 210 "..\\..\\Driver\\Components\\SCR\\SSD1963.C"
}
...
void SSD1963_WriteAddr(unsigned	short	Addr)
{
	(pSSD1963->Port . sDC_PORT->BRR = pSSD1963->Port . sDC_Pin);	
	SSD1963_WriteData(Addr);
	(pSSD1963->Port . sDC_PORT->BSRR = pSSD1963->Port . sDC_Pin);	
}
...
void SSD1963_PowerOn(void)
{
	...
	pSSD1963->Display.WriteIndex(0x00E2);						
	pSSD1963->Display.WriteData(0x0023);	    				
  ...
  LCD_DelaymS(10);
	...
	pSSD1963->Display.WriteIndex(0x0001);  					
	
	pSSD1963->Display.WriteIndex(0x00E6);						
	pSSD1963->Display.WriteData(0x0003);
	pSSD1963->Display.WriteData(0x00FF);
	pSSD1963->Display.WriteData(0x00FF);
	
	pSSD1963->Display.WriteIndex(0x00B0);						
	pSSD1963->Display.WriteData(0x0000);
	pSSD1963->Display.WriteData(0x0000);
	pSSD1963->Display.WriteData((799>>8)&0X00FF);  		
	pSSD1963->Display.WriteData(799&0X00FF);					
	pSSD1963->Display.WriteData((479>>8)&0X00FF);  		
	pSSD1963->Display.WriteData(479&0X00FF);					
	pSSD1963->Display.WriteData(0x0000);									
	
	pSSD1963->Display.WriteIndex(0x00B4);							
	pSSD1963->Display.WriteData((928>>8)&0X00FF);  	
	pSSD1963->Display.WriteData(928&0X00FF);					
																			
	pSSD1963->Display.WriteData((46>>8)&0X00FF);  	
																			
	pSSD1963->Display.WriteData(46&0X00FF);
	pSSD1963->Display.WriteData(48);			   
	pSSD1963->Display.WriteData((15>>8)&0X00FF);  
	pSSD1963->Display.WriteData(15&0X00FF);
	pSSD1963->Display.WriteData(0x0000);
	
	pSSD1963->Display.WriteIndex(0x00B6);							
	pSSD1963->Display.WriteData((525>>8)&0X00FF);   
	pSSD1963->Display.WriteData(525&0X00FF);
	pSSD1963->Display.WriteData((16>>8)&0X00FF);  
	pSSD1963->Display.WriteData(16&0X00FF);
	pSSD1963->Display.WriteData(16);			   
	pSSD1963->Display.WriteData((8>>8)&0X00FF);  
	pSSD1963->Display.WriteData(8&0X00FF);	
	
	pSSD1963->Display.WriteIndex(0x00B8);
	pSSD1963->Display.WriteData(0x0007);    
	pSSD1963->Display.WriteData(0x0001);   	
													
	
	pSSD1963->Display.WriteIndex(0x00BA);
	pSSD1963->Display.WriteData((0X05&0XFF)|(0X04&0XFF));    
	
	pSSD1963->Display.WriteIndex(0x0036); 
	pSSD1963->Display.WriteData(0x0000);
	
	pSSD1963->Display.WriteIndex(0x00F0); 
	pSSD1963->Display.WriteData(0x0003);
	
	
	pSSD1963->Display.WriteIndex(0x0029); 
...
else 
{
	...
	pSSD1963->Display.WriteIndex(0x002A);			
	pSSD1963->Display.WriteData(LCDSYS->Data.HSX>>8);		
	pSSD1963->Display.WriteData(LCDSYS->Data.HSX);			
	pSSD1963->Display.WriteData(LCDSYS->Data.HEX>>8);		
	pSSD1963->Display.WriteData(LCDSYS->Data.HEX);			
	
	pSSD1963->Display.WriteIndex(0x002b);			
	...
	pSSD1963->Display.WriteIndex(0x002c);			
}
...
{
	SSD1963_SetWindowAddress(HSX,HSY,HSX,HSY);	
												...
												)
{
	...
	while(a<=b)
	{
		if(Filled)	
		{
			...
			SSD1963_DrawLine(x,y,x+b,y-a,color);             
			SSD1963_DrawLine(x,y,x-a,y+b,color);             
			SSD1963_DrawLine(x,y,x-b,y-a,color);             
			SSD1963_DrawLine(x,y,x-a,y-b,color);             
			SSD1963_DrawLine(x,y,x+b,y+a,color);             
			SSD1963_DrawLine(x,y,x+a,y-b,color);             
...
{          
	...
	for(x=0;x<=x2-x1;x++)
	{
		for(y=0;y<=y2-y1;y++)
		{
			pSSD1963->Display.WriteData(Color);							
		}
	}	
	(pSSD1963->Port . sCS_PORT->BSRR = pSSD1963->Port . sCS_Pin);	
}
