#line 1 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
...
#line 18 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"

#line 20 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
...
#line 21 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
#line 22 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
#line 23 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
#line 24 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
...
#line 26 "..\\..\\Driver\\WOW\\SCR\\STM32_GPIO.C"
...
void GPIO_ClockConf(GPIO_TypeDef* GPIOx,						
										u16 GPIO_Pin_x									
										)		
{
	if(0	==	GPIOx)
...
void GPIO_DeInitAll(void)
{
	...
	GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1C00)),&GPIO_InitStructure);			
	GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000)),&GPIO_InitStructure);			
	
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)));												
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)));												
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000)));												
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1400)));												
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1800)));												
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1C00)));												
	GPIO_DeInit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000)));												
...
{	
	switch(GPIO_Mode)
	{
		...
		case GPIO_Mode_AIN:					GPIO_Configuration_INA(GPIOx,GPIO_Pin_x);			
					break;
		case GPIO_Mode_IN_FLOATING:	GPIO_Configuration_INF(GPIOx,GPIO_Pin_x);			
					break;
		case GPIO_Mode_IPD:					GPIO_Configuration_IPD(GPIOx,GPIO_Pin_x);			
					break;
		case GPIO_Mode_IPU:					GPIO_Configuration_IPU(GPIOx,GPIO_Pin_x);			
					break;
		
		case GPIO_Mode_Out_OD:	
					switch(GPIO_Speed)
					{
						case GPIO_Speed_10MHz:	GPIO_Configuration_OOD10	(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_2MHz: 	GPIO_Configuration_OOD2		(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_50MHz: 	GPIO_Configuration_OOD50	(GPIOx,GPIO_Pin_x);			
									break;
						default : break;
					}
					break;
		case GPIO_Mode_Out_PP:
					switch(GPIO_Speed)
					{
						case GPIO_Speed_10MHz: 	GPIO_Configuration_OPP10	(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_2MHz: 	GPIO_Configuration_OPP2		(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_50MHz: 	GPIO_Configuration_OPP50	(GPIOx,GPIO_Pin_x);			
									break;
						default : break;
					}
					break;
		case GPIO_Mode_AF_OD:
					switch(GPIO_Speed)
					{
						case GPIO_Speed_10MHz: 	GPIO_Configuration_AOD10	(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_2MHz: 	GPIO_Configuration_AOD2		(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_50MHz: 	GPIO_Configuration_AOD50	(GPIOx,GPIO_Pin_x);			
									break;
						default : break;
					}
					break;
		case GPIO_Mode_AF_PP:
					switch(GPIO_Speed)
					{
						case GPIO_Speed_10MHz: 	GPIO_Configuration_APP10	(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_2MHz: 	GPIO_Configuration_APP2		(GPIOx,GPIO_Pin_x);			
									break;
						case GPIO_Speed_50MHz: 	GPIO_Configuration_APP50	(GPIOx,GPIO_Pin_x);			
									break;
						default : break;
					}
					break;		
