#line 1 "..\\..\\Driver\\Components\\SCR\\EC11Encoder.C"
#line 1 "..\\..\\Driver\\Components\\INC\\EC11Encoder.H"
...
#line 4 "..\\..\\Driver\\Components\\INC\\EC11Encoder.H"
...
typedef struct	_EC11_Pin			
{
	
	
	GPIO_TypeDef* 	EC11_Button_PORT;			
	unsigned short 	EC11_Button_Pin;			
	
	GPIO_TypeDef* 	EC11_A_PORT;					
	unsigned short 	EC11_A_Pin;						
	
	GPIO_TypeDef* 	EC11_B_PORT;					
	unsigned short 	EC11_B_Pin;						

	unsigned	char	LongPressFlag;						
	unsigned 	int		LongPressStartTime;				
	unsigned 	int		LongPressEffectiveTime;		
	
	unsigned 	int		ButtonEffectiveTime;		
	unsigned 	long	EncoderEffectiveTime;		
	
	
	unsigned	char	ButtonActiveFlag;			
	unsigned	int		ButtonTimeCount;			
	unsigned	long	EncoderTimeCountA;		
	unsigned	long	EncoderTimeCountB;		
...
#line 2 "..\\..\\Driver\\Components\\SCR\\EC11Encoder.C"
...
#line 5 "..\\..\\Driver\\Components\\SCR\\EC11Encoder.C"

#line 7 "..\\..\\Driver\\Components\\SCR\\EC11Encoder.C"
...
void EC11_PinConf(EC11_ConfTypeDef *EC11_Conf)
{
	GPIO_Configuration_IPU	(EC11_Conf->EC11_Button_PORT,		EC11_Conf->EC11_Button_Pin);		
	GPIO_Configuration_IPU	(EC11_Conf->EC11_A_PORT,				EC11_Conf->EC11_A_Pin);					
	GPIO_Configuration_IPU	(EC11_Conf->EC11_B_PORT,				EC11_Conf->EC11_B_Pin);					
	
	
	if(EC11_Conf->LongPressFlag!=0)			
	{
		if(EC11_Conf->LongPressStartTime==0)	
		{
			EC11_Conf->LongPressStartTime=3000000;	
		}
		if(EC11_Conf->LongPressEffectiveTime==0)	
		{
			EC11_Conf->LongPressEffectiveTime=500000;	
		}
	}
	if(EC11_Conf->ButtonEffectiveTime==0)	
	{
		EC11_Conf->ButtonEffectiveTime=50000;			
	}
	if(EC11_Conf->EncoderEffectiveTime==0)	
	{
		EC11_Conf->EncoderEffectiveTime=800;				
	}
...
EC11_StatusTypeDef EC11_GetStatus(EC11_ConfTypeDef *EC11_Conf)
{
	...
	if(GPIO_ReadInputDataBit(EC11_Conf->EC11_Button_PORT,EC11_Conf->EC11_Button_Pin)==0)		
	{

		
		if(EC11_Conf->LongPressFlag==0&&EC11_Conf->ButtonActiveFlag==0)
		{			
			if(EC11_Conf->ButtonTimeCount<EC11_Conf->ButtonEffectiveTime)	
			{
				EC11_Conf->ButtonTimeCount++;		
			}
			else
			{
				EC11_Conf->ButtonActiveFlag=1;	
				return(EC11_Button);		
			}
		}
		...
		{
			EC11_Conf->ButtonTimeCount++;		
			if(EC11_Conf->ButtonTimeCount>=EC11_Conf->ButtonEffectiveTime&&EC11_Conf->ButtonActiveFlag==0)	
			{
				EC11_Conf->ButtonActiveFlag=1;	
				return(EC11_Button);		
			}
			else if(EC11_Conf->ButtonTimeCount>=EC11_Conf->LongPressStartTime&&EC11_Conf->ButtonActiveFlag==1)	
			{
				if(EC11_Conf->ButtonTimeCount>=EC11_Conf->LongPressStartTime+EC11_Conf->LongPressEffectiveTime)		
				{
					EC11_Conf->ButtonTimeCount-=EC11_Conf->LongPressEffectiveTime;			
					return(EC11_Button);		
				}				
			}
		}
	...
	{
		EC11_Conf->ButtonActiveFlag=0;	
		EC11_Conf->ButtonTimeCount=0;		
	}
	
	if(GPIO_ReadInputDataBit(EC11_Conf->EC11_A_PORT,EC11_Conf->EC11_A_Pin)==0)		
	{
		EC11_Conf->EncoderTimeCountA++;		
	}
	if(GPIO_ReadInputDataBit(EC11_Conf->EC11_B_PORT,EC11_Conf->EC11_B_Pin)==0)		
	{
		EC11_Conf->EncoderTimeCountB++;		
	}
	if(		(GPIO_ReadInputDataBit(EC11_Conf->EC11_A_PORT,EC11_Conf->EC11_A_Pin)==1)				&&(GPIO_ReadInputDataBit(EC11_Conf->EC11_B_PORT,EC11_Conf->EC11_B_Pin)==1)				&&(EC11_Conf->EncoderTimeCountA>EC11_Conf->EncoderEffectiveTime										&&EC11_Conf->EncoderTimeCountB>EC11_Conf->EncoderEffectiveTime)
		...
		)
	{
		...
		{
			EC11_Status=EC11_ClockWise;					
		}
		else
		{
			EC11_Status=EC11_AntiClockWise;				
		}		
		EC11_Conf->EncoderTimeCountA=0;		
		EC11_Conf->EncoderTimeCountB=0;		
		return(EC11_Status);
	}
	return(EC11_Status);
}
