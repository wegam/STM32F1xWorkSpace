#line 1 "..\\..\\Driver\\FatFs\\source\\FatFsAPI.c"
...
#line 12 "..\\..\\Driver\\FatFs\\source\\FatFsAPI.c"
...
{ 
  ...
  sSDFatFsPort.Port.SPIx = ((SPI_TypeDef *) (((u32)0x40000000) + 0x3800));
  sSDFatFsPort.Port.CS_PORT  = ((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2000));
  sSDFatFsPort.Port.CS_Pin   = ((u16)0x0040);
  sSDFatFsPort.Port.SPI_BaudRatePrescaler_x=((u16)0x0038);
