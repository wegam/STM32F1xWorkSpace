#line 1 "..\\..\\Driver\\Components\\SCR\\TM1618.C"
#line 1 "..\\..\\Driver\\Components\\INC\\TM1618.H"
...
#line 4 "..\\..\\Driver\\Components\\INC\\TM1618.H"
...
typedef struct	_TM1618_Pin
{
	...
	GPIO_TypeDef* 	TM1618_DIO_PORT;				
	unsigned short 	TM1618_DIO_Pin;				
	
	
	GPIO_TypeDef* 	TM1618_CLK_PORT;				
	unsigned short 	TM1618_CLK_Pin;				
	
	
	GPIO_TypeDef* 	TM1618_STB_PORT;				
	unsigned short 	TM1618_STB_Pin;				
...
#line 2 "..\\..\\Driver\\Components\\SCR\\TM1618.C"
...
#line 3 "..\\..\\Driver\\Components\\SCR\\TM1618.C"




unsigned char TM1618_Daddr[]={0XC0,0XC2,0XC4,0XC6,0XC8,0XCA,0XCC,0XCE};			
unsigned char TM1618_SegCode[]={0x3F,0X06,0X5B,0X4F,0x66,0X6D,0X7D,0x07,0x7f,0x6f,0x00,0xff};
unsigned char TM1618_CovSeg[8]={0};			
...
void TM1618_PinConf(TM1618_Pindef *Pinfo)
{
	GPIO_Configuration_OPP50	(Pinfo->TM1618_DIO_PORT,		Pinfo->TM1618_DIO_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->TM1618_CLK_PORT,		Pinfo->TM1618_CLK_Pin);			
	GPIO_Configuration_OPP50	(Pinfo->TM1618_STB_PORT,		Pinfo->TM1618_STB_Pin);			
}
...
void TM1618_WriteCommand(TM1618_Pindef *Pinfo,unsigned char command)
{
	...
	GPIO_ResetBits(Pinfo->TM1618_STB_PORT, Pinfo->TM1618_STB_Pin);			
	TM1618_Delay(1000);
	TM1618_WriteByte(Pinfo,0x44);	
	TM1618_Delay(1000);
	GPIO_SetBits(Pinfo->TM1618_STB_PORT, Pinfo->TM1618_STB_Pin);		
	TM1618_Delay(1000);
	
	GPIO_ResetBits(Pinfo->TM1618_STB_PORT, Pinfo->TM1618_STB_Pin);			
	TM1618_Delay(1000);
	TM1618_WriteByte(Pinfo,command);				
	TM1618_Delay(1000);
	GPIO_SetBits(Pinfo->TM1618_STB_PORT, Pinfo->TM1618_STB_Pin);		
	TM1618_Delay(1000);
}
...
void TM1618_WriteDataN(TM1618_Pindef *Pinfo,u16 Data)
{
	...
	{
		GPIO_SetBits(Pinfo->TM1618_STB_PORT, Pinfo->TM1618_STB_Pin);			
		TM1618_WriteByte(Pinfo,TM1618_Daddr[i]);				
		TM1618_Delay(1000);
		TM1618_WriteByte(Pinfo,TM1618_CovSeg[i]);				
		TM1618_Delay(1000);
		GPIO_ResetBits(Pinfo->TM1618_STB_PORT, Pinfo->TM1618_STB_Pin);		
	}
}
