#line 1 "..\\..\\Driver\\Components\\SCR\\A3987.C"

#line 1 "..\\..\\Driver\\Components\\INC\\A3987.H"
...
#line 5 "..\\..\\Driver\\Components\\INC\\A3987.H"
...
typedef struct	_A3987_Pin
{
	...
	GPIO_TypeDef* 	A3987_PUL_PORT;				
	unsigned short 	A3987_PUL_Pin;				
	
	
	GPIO_TypeDef* 	A3987_DIR_PORT;				
	unsigned short 	A3987_DIR_Pin;				
	
	
	GPIO_TypeDef* 	A3987_EN_PORT;				
	unsigned short 	A3987_EN_Pin;				
	
	
	GPIO_TypeDef* 	A3987_MS1_PORT;				
	unsigned short 	A3987_MS1_Pin;				
	
	
	GPIO_TypeDef* 	A3987_MS2_PORT;				
	unsigned short 	A3987_MS2_Pin;				
	
	
	GPIO_TypeDef* 	A3987_RS_PORT;				
	unsigned short 	A3987_RS_Pin;				
...
#line 3 "..\\..\\Driver\\Components\\SCR\\A3987.C"
...
#line 4 "..\\..\\Driver\\Components\\SCR\\A3987.C"
...
void A3987_PinConf(A3987_Pindef *Pinfo)
{
	GPIO_Configuration_OPP50	(Pinfo->A3987_PUL_PORT,			Pinfo->A3987_PUL_Pin);					
	GPIO_Configuration_OPP50	(Pinfo->A3987_DIR_PORT,			Pinfo->A3987_DIR_Pin);					
	GPIO_Configuration_OPP50	(Pinfo->A3987_EN_PORT,			Pinfo->A3987_EN_Pin);					
	GPIO_Configuration_OPP50	(Pinfo->A3987_MS1_PORT,			Pinfo->A3987_MS1_Pin);					
	GPIO_Configuration_OPP50	(Pinfo->A3987_MS2_PORT,			Pinfo->A3987_MS2_Pin);					
	GPIO_Configuration_OPP50	(Pinfo->A3987_RS_PORT,			Pinfo->A3987_RS_Pin);					
	...
	GPIO_ResetBits(Pinfo->A3987_EN_PORT, Pinfo->A3987_EN_Pin);			
	GPIO_ResetBits(Pinfo->A3987_MS1_PORT,			Pinfo->A3987_MS1_Pin);			
	GPIO_ResetBits(Pinfo->A3987_MS2_PORT,			Pinfo->A3987_MS2_Pin);			
	GPIO_SetBits(Pinfo->A3987_DIR_PORT,			Pinfo->A3987_DIR_Pin);			
}
...
void A3987_StepDriver(A3987_Pindef *Pinfo)
{
	...
	if(Pinfo->A3987_StepCnt>8)
	{
		...
		GPIO_Toggle(Pinfo->A3987_PUL_PORT,			Pinfo->A3987_PUL_Pin);			
	}
