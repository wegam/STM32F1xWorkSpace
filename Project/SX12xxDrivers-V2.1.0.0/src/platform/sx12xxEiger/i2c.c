...
*注释				:	wegam@sina.com
*******************************************************************************/
static void I2cFsmcClkEnable( bool enable )		//I2C
{
    __IO int32_t i;
...
*注释				:	wegam@sina.com
*******************************************************************************/
uint8_t I2cWrite( uint8_t deviceAddr, uint8_t data )		//I2C写
{
    __IO int32_t i;
    uint32_t timeOut;
...
*注释				:	wegam@sina.com
*******************************************************************************/
uint8_t I2cRead( uint8_t deviceAddr, uint8_t *data )		//I2C读
{
    __IO int32_t i;
    int32_t size = 1;
    uint32_t timeOut;
...
*注释				:	wegam@sina.com
*******************************************************************************/
uint8_t I2cWriteBuffer( uint8_t deviceAddr, uint16_t addr, uint8_t *buffer, uint16_t size, tI2cAddrSize addrSize )		//I2C写缓冲
{
    __IO int32_t i;
    uint32_t timeOut;
...
*注释				:	wegam@sina.com
*******************************************************************************/
uint8_t I2cReadBuffer( uint8_t deviceAddr, uint16_t addr, uint8_t *buffer, uint16_t size, tI2cAddrSize addrSize )		//I2C读缓冲数据
{
    __IO int32_t i;
    uint32_t timeOut;
...
/**
  ...
  * @retval None
  */
static void I2cGpioConfig( void )		//I2C管脚配置
{
...
/**
  ...
  * @retval None
  */
static void I2cConfig( void )			//I2C配置
{
