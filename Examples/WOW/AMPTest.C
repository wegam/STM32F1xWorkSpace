...
unsigned char OpenLed[11]={0x7E,0x06,0x03,0x01,0x01,0x00,0x01,0x01,0x00,0x00,0x7F};  //Address1中控制输出端口1以LED驱动的方式打开
unsigned char ClosLed[11]={0x7E,0x06,0x03,0x01,0x01,0x00,0x01,0x00,0x00,0x00,0x7F};  //Address1中控制输出端口1以LED驱动的方式关闭
