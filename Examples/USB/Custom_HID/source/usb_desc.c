...
/* USB Standard Device Descriptor */	//设备描述
...
/* USB Configuration Descriptor */	//配置描述
...
const u8 CustomHID_ConfigDescriptor[CUSTOMHID_SIZ_CONFIG_DESC] =
  {
    ...
    /* 27 */
    0x07,          /* bLength: Endpoint Descriptor size */	//节点
    USB_ENDPOINT_DESCRIPTOR_TYPE, /* bDescriptorType: */

    0x81,          /* bEndpointAddress: Endpoint Address (IN) */	//输入节点
    0x03,          /* bmAttributes: Interrupt endpoint */				//中断节点
    0x02,          /* wMaxPacketSize: 2 Bytes max */						//数据大小
    0x00,
  ...
  ; /* CustomHID_ConfigDescriptor */		//汇报描述
