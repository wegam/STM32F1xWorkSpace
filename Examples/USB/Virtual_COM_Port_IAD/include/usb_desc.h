...
extern const u8 Virtual_Com_Port_QualifierDescriptor[10];
...
#define Multiple_CONF_DESCRIPTOR(wTotalLength,			/*配置描述符总长度*/	\
  ...
  wTotalLength,					/* wTotalLength---描述符总长度*/															\
  bNumInterfaces,  			/* bNumInterfaces--包含口数量*/															\
...
/* Call Management Functional Descriptor */                             \
		Multiple_CMF_Descriptor(datIfNum),																	\
