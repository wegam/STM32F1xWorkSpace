...
CD4511Def CD4511;		//第一位
CD4511Def CD4511_Pin1;		//第一位
CD4511Def CD4511_Pin2;		//第二位
CD4511Def CD4511_Pin3;		//第三位
...
//	GPIO_Configuration_IPU(GPIOC,GPIO_Pin_7);						//将GPIO相应管脚配置为上拉输入模式----V20170605
	...
	CD4511.Port.A0_PORT=GPIOB;
	CD4511.Port.A0_Pin=GPIO_Pin_0;
	
	CD4511.Port.A1_PORT=GPIOB;
	CD4511.Port.A1_Pin=GPIO_Pin_1;
	
	CD4511.Port.A2_PORT=GPIOB;
	CD4511.Port.A2_Pin=GPIO_Pin_2;
	
	CD4511.Port.A3_PORT=GPIOB;
	CD4511.Port.A3_Pin=GPIO_Pin_3;
	
	CD4511.Port.Seg1_PORT=GPIOB;
	CD4511.Port.Seg1_Pin=GPIO_Pin_15;
	
	CD4511.Port.Seg2_PORT=GPIOB;
	CD4511.Port.Seg2_Pin=GPIO_Pin_14;
	
	CD4511.Port.Seg3_PORT=GPIOB;
	CD4511.Port.Seg3_Pin=GPIO_Pin_5;
...
//	
//	//SEG第一位数码管
//	CD4511_Pin1.Port.A0_PORT=GPIOB;
//	CD4511_Pin1.Port.A0_Pin=GPIO_Pin_0;
//	
//	CD4511_Pin1.Port.A1_PORT=GPIOB;
//	CD4511_Pin1.Port.A1_Pin=GPIO_Pin_1;
//	
//	CD4511_Pin1.Port.A2_PORT=GPIOB;
//	CD4511_Pin1.Port.A2_Pin=GPIO_Pin_2;
//	
//	CD4511_Pin1.Port.A3_PORT=GPIOB;
//	CD4511_Pin1.Port.A3_Pin=GPIO_Pin_3;
//	
//	CD4511_Pin1.Port.Seg1_PORT=GPIOB;
//	CD4511_Pin1.Port.Seg1_Pin=GPIO_Pin_15;
//	
//	CD4511_Initialize(&CD4511_Pin1);
//	
//	//SEG2第二位数码管
//	CD4511_Pin2.Port.A0_PORT=GPIOB;
//	CD4511_Pin2.Port.A0_Pin=GPIO_Pin_0;
//	
//	CD4511_Pin2.Port.A1_PORT=GPIOB;
//	CD4511_Pin2.Port.A1_Pin=GPIO_Pin_1;
//	
//	CD4511_Pin2.Port.A2_PORT=GPIOB;
//	CD4511_Pin2.Port.A2_Pin=GPIO_Pin_2;
//	
//	CD4511_Pin2.Port.A3_PORT=GPIOB;
//	CD4511_Pin2.Port.A3_Pin=GPIO_Pin_3;
//	
//	CD4511_Pin2.Port.Seg2_PORT=GPIOB;
//	CD4511_Pin2.Port.Seg2_Pin=GPIO_Pin_14;
//	
//	CD4511_PinConf(&CD4511_Pin2);
//	
//	//SEG3第三位数码管
//	CD4511_Pin3.Port.A0_PORT=GPIOB;
//	CD4511_Pin3.Port.A0_Pin=GPIO_Pin_0;
//	
//	CD4511_Pin3.Port.A1_PORT=GPIOB;
//	CD4511_Pin3.Port.A1_Pin=GPIO_Pin_1;
//	
//	CD4511_Pin3.Port.A2_PORT=GPIOB;
//	CD4511_Pin3.Port.A2_Pin=GPIO_Pin_2;
//	
//	CD4511_Pin3.Port.A3_PORT=GPIOB;
//	CD4511_Pin3.Port.A3_Pin=GPIO_Pin_3;
//	
//	CD4511_Pin3.Port.Seg3_PORT=GPIOB;
//	CD4511_Pin3.Port.Seg3_Pin=GPIO_Pin_5;
//	
...
//	}
//	CD4511_DisplayON(&CD4511_Pin1);			//关闭显示---关NPN三极管
}
