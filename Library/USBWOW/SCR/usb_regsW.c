...
* Description    : Setthe Endpoint register value.	//设置端点值
* Input          : bEpNum: Endpoint Number.					//端点编号， 
*                  wRegValue.												//要写入的值
* Output         : None.
* Return         : None.
*******************************************************************************/
...
* Description    : Return the Endpoint register value.	//获取端点值
* Input          : bEpNum: Endpoint Number.							//端点编号 
* Output         : None.
* Return         : Endpoint register value.							//端点寄存器的值
*******************************************************************************/
...
* Description    : sets the type in the endpoint register.	//设置端点类型
* Input          : bEpNum: Endpoint Number. 								//端点编号 
*                  wType: type definition.									//要设置的端点类型（usb_regs.h Line151)
* Output         : None.
* Return         : None.
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : GetEPType																//获取端点类型
* Description    : Returns the endpoint type.								
* Input          : bEpNum: Endpoint Number. 								//端点编号
* Output         : None.
* Return         : Endpoint Type														//返回端点类型
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : SetEPTxStatus														//设置发送端点状态
* Description    : Set the status of Tx endpoint.
* Input          : bEpNum: Endpoint Number. 								//端点编号
*                  wState: new state.												//端点状态（usb_regs.h Line163)
* Output         : None.
* Return         : None.
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : SetEPRxStatus														//设置接收端点状态
* Description    : Set the status of Rx endpoint.
* Input          : bEpNum: Endpoint Number. 								//端点编号
*                  wState: new state.												//端点状态（usb_regs.h Line172)
* Output         : None.
* Return         : None.
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : GetEPTxStatus										//获取发送端点状态
* Description    : Returns the endpoint Tx status.	
* Input          : bEpNum: Endpoint Number. 				//端点编号
* Output         : None.
* Return         : Endpoint TX Status								//返回发送端点状态
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : GetEPRxStatus										//获取接收端点状态
* Description    : Returns the endpoint Rx status.
* Input          : bEpNum: Endpoint Number. 				//端点编号
* Output         : None.
* Return         : Endpoint RX Status								//返回接收端点状态
*******************************************************************************/
