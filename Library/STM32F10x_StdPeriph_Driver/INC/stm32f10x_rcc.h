...
#define IS_RCC_APB2_PERIPH(PERIPH) ((((PERIPH) == RCC_APB2Periph_AFIO)||\
...
#define IS_RCC_APB1_PERIPH(PERIPH) ((((PERIPH)== RCC_APB1Periph_TIM2)||\
																			((PERIPH)== RCC_APB1Periph_TIM3)||\
																			((PERIPH)== RCC_APB1Periph_TIM4)||\
																			((PERIPH)== RCC_APB1Periph_TIM5)||\
																			((PERIPH)== RCC_APB1Periph_TIM6)||\
																			((PERIPH)== RCC_APB1Periph_TIM7)||\
																			((PERIPH)== RCC_APB1Periph_WWDG)||\
																			...
																			((PERIPH)== RCC_APB1Periph_USB)||\
																			((PERIPH)== RCC_APB1Periph_CAN)||\
																			((PERIPH)== RCC_APB1Periph_BKP)||\
																			((PERIPH)== RCC_APB1Periph_PWR)||\
																			((PERIPH)== RCC_APB1Periph_DAC)||\
																			((PERIPH)== RCC_APB1Periph_ALL)))
...
void RCC_SYSCLKConfig(u32 RCC_SYSCLKSource);						//设置系统时钟源（SYSCLK）
u8 RCC_GetSYSCLKSource(void);														//返回用作系统时钟的时钟源
void RCC_HCLKConfig(u32 RCC_SYSCLK);										//设置AHB时钟（HCLK）
void RCC_PCLK1Config(u32 RCC_HCLK);											//设置低速AHB时钟（PCLK1）
void RCC_PCLK2Config(u32 RCC_HCLK);											//设置高速AHB时钟（PCLK2）
...
void RCC_ADCCLKConfig(u32 RCC_PCLK2);										//设置ADC分频时钟（ADCCLK）
void RCC_LSEConfig(u8 RCC_LSE);													//设置外部低速晶振（LSE）
