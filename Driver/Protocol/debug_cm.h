...
#define DP_IDCODE      0x00        // IDCODE Register (Read only)±êÊ¶´úÂë¼Ä´æÆ÷
#define DP_ABORT       0x00        // Abort Register (Write only)ÖÕÖ¹¼Ä´æÆ÷
#define DP_CTRL_STAT   0x04        // Control & Status¿ØÖÆ/×´Ì¬¼Ä´æÆ÷
#define DP_WCR         0x04        // Wire Control Register (SW Only)Ïß¿Ø¼Ä´æÆ÷
...
#define DAPABORT       0x00000001  // DAP Abort                       //AP Abort register£¨APÖÐÖ¹¼Ä´æÆ÷£©£ºÖÐÖ¹¼Ä´æÆ÷Ç¿ÖÆAPÊÂÎñÖÐÖ¹
