...
void R61509V_PinConf(R61509V_Pindef *Pinfo)
{
	...
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sBL_PORT,				R61509V_sPinfo->R61509V_sBL_Pin);					//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sRD_PORT,				R61509V_sPinfo->R61509V_sRD_Pin);					//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sREST_PORT,			R61509V_sPinfo->R61509V_sREST_Pin);				//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sRS_PORT,				R61509V_sPinfo->R61509V_sRS_Pin);					//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sWR_PORT,				R61509V_sPinfo->R61509V_sWR_Pin);					//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sCS_PORT,				R61509V_sPinfo->R61509V_sCS_Pin);					//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sTE_PORT,				R61509V_sPinfo->R61509V_sTE_Pin);					//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605
	GPIO_Configuration_OPP50	(R61509V_sPinfo->R61509V_sDATABUS_PORT,		R61509V_sPinfo->R61509V_sDATABUS_Pin);			//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度2MHz----V20170605	
