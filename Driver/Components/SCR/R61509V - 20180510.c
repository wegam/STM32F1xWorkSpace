...
R61509VPortDef *LCDPort	=	0;					//宏定义使用变量
...
//	SysTick_DeleymS(LCDTime);				//SysTick延时nmS
//	
//	R61509V_Clean(R61509V_GBLUE);			//清除屏幕函数--
//	SysTick_DeleymS(LCDTime);				//SysTick延时nmS
	
	R61509V_Clean(R61509V_RED);			//清除屏幕函数--
	SysTick_DeleymS(LCDTime);				//SysTick延时nmS
	
//	R61509V_Clean(R61509V_MAGENTA);			//清除屏幕函数--
//	SysTick_DeleymS(LCDTime);				//SysTick延时nmS
//	
//	R61509V_Clean(R61509V_GREEN);			//清除屏幕函数--
//	SysTick_DeleymS(LCDTime);				//SysTick延时nmS
//	
//	R61509V_Clean(R61509V_CYAN);			//清除屏幕函数--
//	SysTick_DeleymS(LCDTime);				//SysTick延时nmS
//	
