...
{
	unsigned short	MaxX;						//水平最大点数
	unsigned short 	MaxY;						//垂直最大点数
...
extern R61509VPortDef *R61509VPort;

#define R61509V_CS_HIGH					(R61509VPort->sCS_PORT->BSRR		= R61509VPort->sCS_Pin)
#define R61509V_CS_LOW					(R61509VPort->sCS_PORT->BRR 		= R61509VPort->sCS_Pin)
#define R61509V_RS_HIGH					(R61509VPort->sRS_PORT->BSRR 		= R61509VPort->sRS_Pin)
#define R61509V_RS_LOW					(R61509VPort->sRS_PORT->BRR 		= R61509VPort->sRS_Pin)
#define R61509V_WR_HIGH					(R61509VPort->sWR_PORT->BSRR 		= R61509VPort->sWR_Pin)
#define R61509V_WR_LOW					(R61509VPort->sWR_PORT->BRR 		= R61509VPort->sWR_Pin)
#define R61509V_RD_HIGH					(R61509VPort->sRD_PORT->BSRR 		= R61509VPort->sRD_Pin)
#define R61509V_RD_LOW					(R61509VPort->sRD_PORT->BRR 		= R61509VPort->sRD_Pin)
#define R61509V_RST_HIGH				(R61509VPort->sREST_PORT->BSRR 	= R61509VPort->sREST_Pin)
#define R61509V_RST_LOW					(R61509VPort->sREST_PORT->BRR 	= R61509VPort->sREST_Pin)
#define R61509V_TE_HIGH					(R61509VPort->sTE_PORT->BSRR 		= R61509VPort->sTE_Pin)
#define R61509V_TE_LOW					(R61509VPort->sTE_PORT->BRR 		= R61509VPort->sTE_Pin)
#define R61509V_DATABUS_PORT		(R61509VPort->sDATABUS_PORT)

#if 1
	#define R61509V_BL_ON		PWM_OUT((TIM_TypeDef*) TIM2_BASE,PWM_OUTChannel4,1000,100)	//(R61509V_BL_PORT->BSRR = R61509V_BL_PIN)
	#define R61509V_BL_OFF	PWM_OUT((TIM_TypeDef*) TIM2_BASE,PWM_OUTChannel4,1000,0)		//(R61509V_BL_PORT->BRR = R61509V_BL_PIN)
#else
	#define R61509V_BL_ON		(R61509V_BL_PORT->BSRR = R61509V_BL_PIN)
	#define R61509V_BL_OFF	(R61509V_BL_PORT->BRR = R61509V_BL_PIN)
...
void CoordinateTransformb(unsigned short *x1,unsigned short *y1,unsigned short *x2,unsigned short *y2);//坐标转换
