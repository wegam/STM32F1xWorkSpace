...
/*设备属性*/
DEVICE_PROP VirtualCom_DeviceProperty =				//
  {
...
void Virtual_Com_Port_Reset(void)
{
  ...
  SetEPRxCount(ENDP0, VirtualCom_DeviceProperty.MaxPacketSize);		//设置端点0的接收最大包
